...
4. If it appears to do nothing, run START_SIDECAR.cmd instead.
...
The Microsoft Edge WebView2 Runtime is required for the embedded ChatGPT panel. A missing WebView2 Runtime should now produce a visible error after the Sidecar window opens.
